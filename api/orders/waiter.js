// api/orders/waiter.js — POST /api/orders/waiter (waiter places order)
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    return res.status(201).json({ id: docRef.id, message: 'Waiter order created.' });
  } catch (err) {
    console.error('[Orders] createWaiterOrder error:', err);
